...
That is a 32768x32768 image, the full window, 19 threads, lambda 0.5, and an iteration
...
[`../data/srad_allConf_19c11f.csv.gz`](../data/srad_allConf_19c11f.csv.gz), and it is
